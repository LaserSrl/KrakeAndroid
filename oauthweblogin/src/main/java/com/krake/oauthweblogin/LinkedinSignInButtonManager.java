...
public class LinkedinSignInButtonManager extends LoginViewManager implements View.OnClickListener {

    private static final int LOGIN_WITH_LINKEDIN_REQUEST = 30764;
    private final View signInButton;
    private String token;


    public LinkedinSignInButtonManager(@NonNull Activity activity, @NonNull LoginListener loginFragment) {
        super(activity, loginFragment);

        signInButton = activity.getLayoutInflater().inflate(R.layout.linkedin_login_button, null);
    ...
    public boolean onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == LOGIN_WITH_LINKEDIN_REQUEST && resultCode == Activity.RESULT_OK) {
    ...
    public boolean sendTokenToOrchard() {
        ...
        if (token != null) {
            ...
            RemoteRequest request = new RemoteRequest(getActivity())
                    ...
                    .setQuery(getString(R.string.orchard_login_provider_key), getString(R.string.orchard_login_provider_linkedin))
    ...
    public void onClick(View view) {
        if (view == signInButton) {
            ...
            builder.scheme("https")
                    ...
                    .appendQueryParameter("client_id", getString(R.string.linkedin_api_key))
                    .appendQueryParameter("state", getString(R.string.orchard_api_key))
            ...
            getActivity().startActivityForResult(signInIntent, LOGIN_WITH_LINKEDIN_REQUEST);
        }
    }
}
