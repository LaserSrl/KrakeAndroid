...
/**
 * Instrumented test class for [DrawableCompatTextView].
 */
class DrawableCompatTextViewTest {
    @JvmField
    @Rule
    val viewTestRule = viewTestRule<DrawableCompatTextView>()

    private lateinit var spiedView: DrawableCompatTextView
    ...
    private inline fun evaluateOnSpy(crossinline block: (DrawableCompatTextView) -> Unit) {
